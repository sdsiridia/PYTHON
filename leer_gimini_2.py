            ...
            if isinstance(response_part, tuple):
                ...
                def tiene_errores(body: str, mail_id: str) -> bool:
                    ...
                    if PALABRA_NUMERO_ERRORES in body:
                        ...
                        sub_body = body[indice + len(PALABRA_NUMERO_ERRORES):indice + 50]
                        try:
                            errores = int(sub_body.split(".")[0])
                        except ValueError:
                            print(f"No se pudo convertir a int: {sub_body} en el correo {mail_id}")
                            return False
                        ...
                        sub_body = body[indice + len(PALABRA_ERRORES):indice + 50]
                        try:
                            errores = int(sub_body.split(".")[0])
                        except ValueError:
                            print(f"No se pudo convertir a int: {sub_body} en el correo {mail_id}")
